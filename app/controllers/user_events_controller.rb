class UserEventsController < ApplicationController
  ...
  def index
    ...
    liked_events = Like.where(:user_id => current_user.id).pluck(:user_event_id)
    @liked_events = UserEvent.where(:id => liked_events)
  end
  ...
  private
    ...
    def user_event_params
      params.require(:user_event).permit(:event_name, :event_date, :user_id)
    end
end
